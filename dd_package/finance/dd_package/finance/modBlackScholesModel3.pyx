...
cpdef class ENUM_OPTION_TYPE(enum.Enum):
    EUROPEAN_CALL = 1
    EUROPEAN_PUT = 2
    AMERICAN_CALL = 3
    AMERICAN_PUT = 4
...
class BlackScholesModel_OLD():
    ...
    def __init__(self, enum_option_type, 
        ...
        self.gen_d1()
        self.gen_d2()
        BlackScholesModel_OLD.__int_option_count += 1
...
if __name__ == '__main__':
    DBS = BlackScholesModel_OLD(ENUM_OPTION_TYPE.EUROPEAN_PUT,49.0,50.0,2.0,0.05,0.20,0.0)
# =============================================================================
